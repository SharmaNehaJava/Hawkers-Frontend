...
const SignUp = () => {
  ...
  const handleSignUp = useCallback(async (e) => {
    e.preventDefault();
    if (!mobileVerified && !testMode) {
      alert('Please verify your mobile number first.');
      return;
    }
    setIsLoading(true);
    try {
      const response = await instance.post('/api/users/register', { name, email, mobile, dob, gender, testMode });
  ...
  }, [name, email, mobile, dob, gender, mobileVerified, testMode, login, navigate]);
